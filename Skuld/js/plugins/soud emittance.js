...
//=============================================================================\
//-----------------------------------------------------------------------------\
// Especifica\'e7\'f5es do plugin (N\'e3o Modifique!)\
...
@author Masked\
\
@plugindesc Permite definir uma emiss\'e3o de som para eventos com posi\'e7\'e3o e \
dist\'e2ncia.\
<MBS SEmittance>\
\
@param Use HRTF\
@desc Determina quando usar HRTF para o posicionamento 3D do som ou n\'e3o.\
(O RPG Maker usa equalpower por padr\'e3o).\
@default true\
\
@help\
===========================================================================\
Introdu\'e7\'e3o\
===========================================================================\
Permite que voc\'ea escolha um efeito sonoro para ser emitido por um evento,\
dessa forma conforme o jogador se mover a posi\'e7\'e3o de volume do som se \
alteram de acordo com a dist\'e2ncia do evento.\
\
===========================================================================\
Como usar\
===========================================================================\
Para definir uma emiss\'e3o de som, ponha num coment\'e1rio do evento:\
<s_emittance: folder/file> \
\
Ex.:\
<s_emittance: bgs/Drips>\
...
<s_e_radius: 3>\
\
Para definir o volume e frequ\'eancia (pitch) do som:\
<s_e_volume: N>\
<s_e_pitch: N>\
\
Ex.:\
...
<s_e_pitch: 50>\
\
O raio \'e9 medido em tiles, voc\'ea pode usar valores decimais se quiser, se \
n\'e3o for definido um raio, ele ser\'e1 1.\
*/\
\
